  ...
  public static class JdkClient {
    ...
    private static BeanInstanceSupplier<JdkClientHttpConnectorFactory> getJdkClientHttpConnectorFactoryInstanceSupplier(
      ...
      return BeanInstanceSupplier.<JdkClientHttpConnectorFactory>forFactoryMethod(ClientHttpConnectorFactoryConfiguration.JdkClient.class, "jdkClientHttpConnectorFactory")
              .withGenerator((registeredBean) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.autoconfigure.web.reactive.function.client.ClientHttpConnectorFactoryConfiguration$JdkClient", ClientHttpConnectorFactoryConfiguration.JdkClient.class).jdkClientHttpConnectorFactory());
    }
    ...
    public static BeanDefinition getJdkClientHttpConnectorFactoryBeanDefinition() {
      ...
      beanDefinition.setFactoryBeanName("org.springframework.boot.autoconfigure.web.reactive.function.client.ClientHttpConnectorFactoryConfiguration$JdkClient");
