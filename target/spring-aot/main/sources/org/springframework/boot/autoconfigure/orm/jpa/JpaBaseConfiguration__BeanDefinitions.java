...
public class JpaBaseConfiguration__BeanDefinitions {
  ...
  public static class PersistenceManagedTypesConfiguration {
    ...
    private static PersistenceManagedTypes getPersistenceManagedTypesInstance() {
      List<String> managedClassNames = List.of("com.zeta.ai.zeta_ai.application.dtos.BaseEntity", "com.zeta.ai.zeta_ai.modules.cars.models.Car", "com.zeta.ai.zeta_ai.modules.conversation.models.ConversationHistory");
